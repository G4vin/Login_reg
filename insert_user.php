...
$db_connection = mysqli_connect("localhost","root","","login_registration_Gavin");

if (isset($_POST['username']) && isset($_POST['phone_number']) && isset($_POST['user_email']) && isset($_POST['user_password'])) {

// CHECK IF FIELDS ARE NOT EMPTY
    if (!empty(trim($_POST['username'])) && !empty(trim($_POST['phone_number'])) && !empty(trim($_POST['user_email'])) && !empty($_POST['user_password'])) {
...
// Escape special characters.
        ...
        $phone = mysqli_real_escape_string($db_connection, htmlspecialchars($_POST['phone_number']));
